...
% Absendername
\setkomavar{fromname}{Valentin Resapow}

% Absenderadresse
\setkomavar{fromaddress}{Hoppenstedt str. 74\\21073 Hamburg}

% Absendertelefonnummer
\setkomavar{fromphone}{+49 176 95876955}
...
\setkomavar{fromemail}{\href{mailto:valentin.resapow@tuhh.de}{valentin.resapow@tuhh.de}}
