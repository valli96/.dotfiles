...
autocmd BufRead,BufNewFile *.tex setlocal spell spelllang=en_gb,de_de
autocmd BufRead,BufNewFile *.md setlocal spell spelllang=en_gb,de_de
...
set scrolloff=7
set noswapfile                          " forbit vim to create swap files
...
autocmd! filetype python call Pythonoption()

function! Pythonoption()
  noremap gy :! python3 % <CR>
  " noremap gy i"hallo"
endfunction
